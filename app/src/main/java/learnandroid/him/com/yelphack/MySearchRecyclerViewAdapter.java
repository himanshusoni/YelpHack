...
import learnandroid.him.com.yelphack.SearchFragment.OnListFragmentInteractionListener;
...
public class MySearchRecyclerViewAdapter extends RecyclerView.Adapter<MySearchRecyclerViewAdapter.ViewHolder> {
    ...
    public MySearchRecyclerViewAdapter(List<Business> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mContentView.setText(String.valueOf(mValues.get(position).name()));
